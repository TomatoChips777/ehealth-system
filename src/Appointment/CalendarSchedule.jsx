...
//       try {
//         const response = await axios.get('/api/available-dates'); // Adjust the API endpoint as needed
...
//     setDate(newDate);
//     // Check if there are any available times for the selected date
//     const availableTimesForDate = availableDates.find((availableDate) => new Date(availableDate.date).toDateString() === newDate.toDateString());
//     if (availableTimesForDate) {
//       setAvailableTimes(availableTimesForDate.times);
//     } else {
//       setAvailableTimes([]);
//     }
//   };
...
//       return;
//     }
//     // Add the selected time slot to the API (or database)
//     axios.post('/api/available-dates', {
//       date: date.toISOString().split('T')[0],
//       time: selectedTime,
//     })
//     .then(() => {
//       setShowModal(false);
//       setAvailableTimes([...availableTimes, selectedTime]); // Update available times on UI
//     })
//     .catch((error) => {
...
//     // Remove the time slot from the API (or database)
//     axios.delete(`/api/available-dates/${date.toISOString().split('T')[0]}/${time}`)
//     .then(() => {
//       setAvailableTimes(availableTimes.filter(t => t !== time)); // Update available times on UI
//     })
//     .catch((error) => {
...
//           <div className="mt-4">
//             <h5>Available Times for {date.toDateString()}:</h5>
//             <ul>
//               {availableTimes.map((time) => (
//                 <li key={time}>
//                   {time} <Button variant="danger" size="sm" onClick={() => handleRemoveTimeSlot(time)}>Remove</Button>
//                 </li>
//               ))}
//             </ul>
//           </div>
